...
const ProductDetailsById = () => {
    ...
    const showingStart = reviews.length === 0 ? 0 : (reviewPage - 1) * REVIEWS_PER_PAGE + 1;
    const showingEnd = Math.min(reviewPage * REVIEWS_PER_PAGE, reviews.length);
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="lg:w-[40%] space-y-4">
                        <div className="relative aspect-square bg-white rounded-lg overflow-hidden group">
                            ...
                            >
                                <Heart size={20} className={favorited ? "fill-red-500 text-red-500" : "text-[#08221B]"} />
                            </button>
                        </div>
                    ...
                    <div className="lg:w-1/2 space-y-6">
                        <div>
                            ...
                            <div className="flex justify-between items-start">
                                <h1 className="text-[42px] font-medium font-serif text-[#1C3A2C] leading-tight">{product.name}</h1>
                        ...
                        <div className="pt-6 border-t-2 border-[#6E6E6E] text-sm space-y-2 text-gray-500 mt-10">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Share2 size={16} className="cursor-pointer hover:text-[#B39055] transition-colors"
                                    onClick={() => {
                                        if (navigator.share) {
                                            navigator.share({ title: product.name, text: `Check out ${product.name} at G-Crown Jewellers`, url: `${window.location.origin}/productId/${product._id}` });
                    ...
                    <div className="py-10 max-w-5xl mx-auto">
                        {activeTab === "Description" && (
                            <div className="text-gray-600 leading-loose text-lg font-serif text-center space-y-6">
                                ...
                                <p>Created with precision and care, the Golden Elegance Bracelet embodies G-Crown's commitment to craftsmanship, quality, and lasting beauty—an heirloom-worthy piece meant to shine for generations.</p>
                            </div>
                        )}
                                    ...
                                    <div className="flex justify-between items-center mb-8">
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-gray-500">
                                            ...
                                            <span>
                                                {reviews.length === 0
                                                    ? "No results"
                                                    : `Showing ${showingStart}–${showingEnd} of ${reviews.length}`}
                                            </span>
