    ...
    <div className="font-serif max-w-4xl animate-fadeIn">
        ...
        {addresses.map((item) => (
          <div key={item._id} className="flex justify-between items-start py-5 border-b border-gray-100">
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500 tracking-tight">{item.address}, {item.city}, {item.state}, {item.zip}</p>
      ...
      <form onSubmit={(e) => { e.preventDefault(); handleAddAddress(); }} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 bg-white/50 p-6 border border-gray-100 rounded-lg">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="02-33224455"
            className="p-3.5 border border-gray-100 bg-white outline-none focus:border-[#1B3022] text-sm shadow-sm" />
        </div>
        <div className="col-span-full flex flex-col gap-2">
            ...
            >
              ...
              <form onSubmit={(e) => e.preventDefault()} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-full mt-4">
                  <button type="submit" onClick={handleAddAddress} disabled={isUpdating}
