      ...
      <div className="bg-[#FFF9E9] min-h-[75vh] flex flex-col items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-8">
          ...
          <div className="pt-12 flex justify-center gap-10 border-t border-[#1C3A2C]/5">
            <button onClick={() => navigate("/collections")} className="text-[15px] uppercase tracking-[0.2em] text-gray-400 hover:text-[#1C3A2C] transition-colors">New Arrivals</button>
<button onClick={() => navigate("/collections")} className="text-[15px] uppercase tracking-[0.2em] text-gray-400 hover:text-[#1C3A2C] transition-colors">Best Sellers</button>
          </div>
        </div>
      </div>
    );
